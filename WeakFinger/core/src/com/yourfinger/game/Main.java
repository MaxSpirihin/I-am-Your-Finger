...
public class Main extends Game {
	...
	private final int COMPLETE_WORLDS = 5;
	...
	public void LoadResources() {
		...
		am.load("Textures/Worlds/6.atlas", TextureAtlas.class);
	...
	public void CreateResources() {
		...
		worldAtlas = new TextureAtlas[COMPLETE_WORLDS + 1];
		...
		chooseFinal = am.get("Textures/ChooseFinal.atlas", TextureAtlas.class);
		...
		worldAtlas[5] = am.get("Textures/Worlds/6.atlas", TextureAtlas.class);
		
		//для баланса громкостей
		music[0].setVolume(0.95f);
		music[1].setVolume(0.6f);
		music[2].setVolume(1f);
		music[3].setVolume(0.9f);
		music[4].setVolume(0.78f);
